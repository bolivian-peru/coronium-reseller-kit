    ...
    return (
        <main>
            ...
            <p className="text-sm text-zinc-400 mb-6">
                Signed events from Coronium. Last 50. Review pending and failed-purchase events; notify affected customers yourself. Endpoint:{' '}
                        ...
                        <tbody>
                            {events.map((e: any) => (
                                <tr key={e.id} className="border-t border-zinc-800">
                                    ...
                                    <td className="py-2 text-xs text-zinc-400">{e.state}{e.error ? ` · ${e.error}` : ''}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
